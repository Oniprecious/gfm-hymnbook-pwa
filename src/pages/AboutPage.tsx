    ...
    <div className="standard-page">
      ...
      <main>
        <PageWidth className="about-width">
          ...
          <section className="limitations"><h2>Browser notes</h2><ul><li>Voice recognition uses an on-device English language pack when the browser supports it. The first use may download the pack; unsupported browsers still need a connection.</li><li>iOS can remove website data when device storage is constrained; use settings export as a backup.</li><li>Audio is not included without authoritative tune mapping and redistribution permission.</li></ul></section>
        </PageWidth>
      </main>
    </div>
  )
